...
public class TestAlgorithmX_Astart {
...
//		Stream<String> rows1 = Files.lines(Paths.get("data/1.in"));
	...
	public void test_17() throws IOException {
		assertDeployment("data/17.in", 101924);
	}
	...
	public void test_42() throws IOException {
		assertDeployment("data/42.in", 102099);
	}
	@Test
	...
	public void test_51() throws IOException {
		assertDeployment("data/51.in", 291106);
	}
	@Test
	public void test_52() throws IOException {
		assertDeployment("data/52.in", 291792);
	}
	@Test
	public void test_53() throws IOException {
		assertDeployment("data/53.in", 330584);
	}
	@Test
	public void test_54() throws IOException {
		assertDeployment("data/54.in", 408232);
	}
	@Test
	public void test_55() throws IOException {
		assertDeployment("data/55.in", 810595);
	}
...
//		solution3(dataFile, baseSize);
	...
	private void testAlgorithm(String dataFile, int baseSize) throws IOException {
		...
		new AlgorithmX_AStart().solution(points);
//		new AlgorithmX_AStart_refactor().solution(points);
		
		long systemTime = System.currentTimeMillis();
		List<List<Point>> solution1 = new AlgorithmX_AStart().solution(points);
//		List<List<Point>> solution1 = new AlgorithmX_AStart_refactor().solution(points);
		System.out.println("time================" + (System.currentTimeMillis() - systemTime));
...
//
		...
		System.out.println("solution's single size: " + count.toString());
...
//		System.out.println("all result points's size: " + testPoints.size());
//		
