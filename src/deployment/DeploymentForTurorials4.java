...
public class DeploymentForTurorials4 {
	...
	public List<List<Point>> solution(List<Point> list) {
		...
		allPoints.addAll(singleList);
		allPoints.addAll(doubleList);
		allPoints.addAll(tripleList);
		allPoints.addAll(quateList);
		...
		for (Point point : allPoints) {
			...
			System.out.println(tmPoints.toString());
