...
public class AlgorithmX_AStart_refactor {
...
//				System.out.println(lastNode.x + ", " + lastNode.y);
		...
		public List<List<Point>> searchOptimalResults(Matrix matrix, List<Point> singlePoints, List<List<Point>> multipleSolutions) {
...
//				System.out.println(node2 + "-->" + node2.nextNode);
	...
	public List<List<Point>> findApproximateResults(Matrix matrix2, List<Point> points, List<Point> singlePoints) {
		if (points.isEmpty()) {
			return Collections.emptyList();
		}
	...
	public List<List<Point>> solution(List<Point> list) {
		...
		List<List<Point>> result = findApproximateResults(matrix, list, singlePoints);

//		System.out.println("======================================init process: " + (System.currentTimeMillis() - initStart));

		long searchStart = System.currentTimeMillis();
		List<List<Point>> finalResult = astarAlgorithm.searchOptimalResults(matrix, singlePoints, result);
